...
object DocumentClassifier {
    ...
    private val STRONG_BILL_KEYWORDS = setOf(
        "INVOICE", "TAX INVOICE", "BILL OF SUPPLY", "MEDICAL CLAIM", "CLAIM #", "CLAIM NO", "CLAIM NUMBER",
        "AMOUNT DUE", "SUBTOTAL", "SUB TOTAL", "TOTAL DUE", "GRAND TOTAL",
        "BALANCE DUE", "PAYMENT DUE", "TOTAL PAYABLE", "TOTALS", "TOTAL AMOUNT",
        "GOOD FAITH ESTIMATE", "TOTAL ESTIMATED COST", "AMOUNT OWED"
    )

    private val GENERAL_BILL_KEYWORDS = setOf(
        "BILL", "RECEIPT", "STATEMENT", "CHARGES", "BILLED", "PROCEDURE",
        "PATIENT", "INSURANCE", "CLAIM", "CGST", "SGST", "IGST", "DUE DATE",
        "TAXABLE", "INVOICE DATE", "BILL DATE", "QTY", "RATE", "UNIT PRICE",
        "COPAY", "CO-PAY", "DEDUCTIBLE", "ESTIMATE", "ESTIMATED", "HOSPITAL COST", "INSURANCE COST"
    )
